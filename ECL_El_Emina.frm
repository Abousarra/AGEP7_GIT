...
Begin VB.Form ECL_El_Emina 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin ACTIVESKINLibCtl.Skin Skin2 
         Left            =   0
         OleObjectBlob   =   "ECL_El_Emina.frx":2DC0
         Top             =   0
      End
      ...
      Begin VB.Label Label11 
         Alignment       =   2  'Center
         BackStyle       =   0  'Transparent
         Caption         =   "Â–Â «·‰”Œ… Œ«’… »„Ã„⁄ „œ«—” √„Ì‰… «·Œ«’… »ﬂ—›Ê— „ﬁ—— „‘ —ﬂ —ﬁ„ 259/2011"
         BeginProperty Font 
            Name            =   "Times New Roman"
            Size            =   11.25
            Charset         =   178
   ...
   End
End
Attribute VB_Name = "ECL_El_Emina"
