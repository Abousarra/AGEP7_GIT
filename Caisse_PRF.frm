...
Begin VB.Form Caisse_PRF 
   ...
   Begin VB.ComboBox Combo1 
      ...
      EndProperty
      Height          =   375
      ItemData        =   "Caisse_PRF.frx":0000
      Left            =   5160
      List            =   "Caisse_PRF.frx":000A
...
Atyp = " ⁄œÌ·"
End If
Adet = Combo1.Text + " „‰ ÿ—› «·√” «– ’«Õ» «·—ﬁ„ «· ”·”·Ì " + Text1.Text
Amon = Text2.Text
Acom = "”Ã· «·√”« –…"
...
Call cont
Do While Not cs.EOF
If Label17.Caption = cs!aut Then
cs!sri = Text1.Text
cs!nom = Label1.Caption
cs!dat = DT1.Value
cs!typ = Combo1.Text
cs!mon = Text2.Text
cs!det = Text3.Text
...
s = 0
Call cont
grd2.Rows = cs.RecordCount + 3
Do While Not cs.EOF
If Text1.Text = cs!sri Or Val(Text1.Text) = Val(cs!sri) Then
dat3 = cs!dat
...
Label18.Caption = cs!sri
Adat = Date
Aheu = Time$
Atyp = "Õ–›"
Adet = Label11.Caption + " „‰ ÿ—› «·√” «– ’«Õ» «·—ﬁ„ «· ”·”·Ì " + Label18.Caption
Amon = b
Acom = "”Ã· «·√”« –…"
Auti = directions.Label2.Caption
'****************************************
...
i = 1
Call cont
grd6.Rows = cs.RecordCount + 3
Do While Not cs.EOF
If cs!act = Text6.Text Or cs!act = Text5.Text Then
grd6.Row = i
grd6.Col = 0
grd6.Text = cs!dat
grd6.Col = 1
